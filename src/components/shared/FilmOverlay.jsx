...
export function FilmOverlay() {
  ...
  return (
    <>
      ...
      <div
        aria-hidden
        className="pointer-events-none fixed inset-0 z-[9999] antialiased"
        style={{
          opacity: 0.1,
          backgroundImage: `url("data:image/svg+xml,%3Csvg viewBox='0 0 256 256' xmlns='http://www.w3.org/2000/svg'%3E%3Cfilter 
          id='n'%3E%3CfeTurbulence type='fractalNoise' baseFrequency='0.85' numOctaves='3' stitchTiles='stitch'/%3E%3C/filter%3E%3Crect width='100%25' 
